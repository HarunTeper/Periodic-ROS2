...
from waters.tasks.task import Task
from waters.tasks.taskset import TaskSet
from waters.cechains.chain import CEChain
...
if __name__ == '__main__':
    """Debug."""
    ts_set = [gen_taskset(0.7) for _ in range(5)]
